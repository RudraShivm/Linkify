...
function ProductCreationForm({setProductCreationFormVisible}) {
  ...
  return (
    ...
    <div>
      ...
      <label>
        ...
        <input type="number" name="minimum_delivery_time" required/>
      </div>
...
ProductCreationForm.propTypes = {
    setProductCreationFormVisible: PropTypes.func.isRequired
};
